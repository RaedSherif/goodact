 ...
 *
 * Run: C:\xampp\php\php.exe tests\test_order.php
 */
...
$providerEmail = "test_provider_" . $ts . "@goodact.test";
$buyerEmail    = "test_buyer_"    . $ts . "@goodact.test";
...
$listing = new Listing();
$listing->createWithEAV($providerId, 'Order Test Listing ' . $ts, 'condition', 'used', 0);
